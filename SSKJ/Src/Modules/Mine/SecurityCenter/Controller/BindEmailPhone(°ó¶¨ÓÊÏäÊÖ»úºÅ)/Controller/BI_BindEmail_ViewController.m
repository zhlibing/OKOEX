...
@interface BI_BindEmail_ViewController ()
...
@implementation BI_BindEmail_ViewController
...
-(My_TitleAndInput_View *)phoneView
{
    if (nil == _phoneView) {
        ...
        _phoneView = [[My_TitleAndInput_View alloc]initWithFrame:CGRectMake(0, ScaleW(10), ScreenWidth, ScaleW(88)) title:title placeHolder:placeHolder keyBoardType:keyBoardType];
...
-(BIBindOptionView *)codeOptionView
{
    if (!_codeOptionView)
    {
        _codeOptionView = [[BIBindOptionView alloc]initWithFrame:CGRectMake(0, self.phoneView.bottom, self.phoneView.width, ScaleW(55)) placeHolder:SSKJLocalized(@"请输入验证码",nil) keyBoardType:UIKeyboardTypeNumberPad setSecureTextEntry:NO];
