...
@interface Mine_QRScan_ViewController ()<AVCaptureMetadataOutputObjectsDelegate,CAAnimationDelegate>
//扫码功能
...
@implementation Mine_QRScan_ViewController
...
-(void)scanCodeAction
{
    ...
    UILabel *desLabel = [[UILabel alloc]initWithFrame:CGRectMake(ScaleW(20), y, ScreenWidth - ScaleW(40), 40)];
