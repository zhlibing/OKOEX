...
#import "My_Default_AlertView.h"

@interface My_Default_AlertView ()
...
@implementation My_Default_AlertView
...
{
    if (nil == _titleLabel) {
        _titleLabel = [WLTools allocLabel:SSKJLocalized(@"取消交易", nil) font:systemBoldFont(ScaleW(17)) textColor:kTitleColor frame:CGRectMake(0, ScaleW(27), self.alertView.width, ScaleW(17)) textAlignment:NSTextAlignmentCenter];
    }
    return _titleLabel;
}
...
-(UILabel *)messageLabel
{
    if (nil == _messageLabel)
    {
        ...
        _messageLabel  = [FactoryUI createLabelWithFrame:CGRectMake(ScaleW(10), self.titleLabel.bottom + ScaleW(25), self.alertView.width - ScaleW(20), ScaleW(15)) text:SSKJLocalized(@"是否确认要取消当前交易？", nil) textColor:kTitleColor font:systemFont(ScaleW(15))];
...
-(UIButton *)confirmButton
{
    if (_confirmButton==nil)
    {
        ...
        [_confirmButton setBackgroundColor:kBgColor];
...
{
    if (nil == _cancelLabel) {
        _cancelLabel = [FactoryUI createLabelWithFrame:CGRectMake(0, self.cancelButton.bottom + ScaleW(8), ScaleW(100), ScaleW(13)) text:SSKJLocalized(@"取消",nil) textColor:kTitleColor font:systemFont(ScaleW(13))];
...
-(UIButton *)cancelButton
{
    if (_cancelButton==nil)
    {
        ...
        _cancelButton.layer.borderColor = kBgColor.CGColor;
