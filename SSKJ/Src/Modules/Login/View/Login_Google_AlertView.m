...
{
    if (nil == _titleLabel) {
        _titleLabel = [WLTools allocLabel:SSKJLocalized(@"安全验证", nil) font:systemBoldFont(ScaleW(17)) textColor:kTitleColor frame:CGRectMake(ScaleW(15), ScaleW(28), ScaleW(200), ScaleW(14)) textAlignment:NSTextAlignmentLeft];
    }
    return _titleLabel;
}
...
-(UIButton *)confirmButton
{
    if (nil == _confirmButton) {
        ...
        [_confirmButton setTitleColor:kBgColor forState:UIControlStateNormal];
