...
@interface SSKJ_Default_ActionsheetView ()
...
@implementation SSKJ_Default_ActionsheetView
...
{
    SSKJ_Default_ActionsheetView *actionSheet = [[SSKJ_Default_ActionsheetView alloc]initWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenHeight)];
...
-(UIButton *)cancleButton
{
    if (nil == _cancleButton) {
        ...
        _cancleButton.backgroundColor = kBgColor;
    }
...
{
    if (nil == _titleLabel) {
        _titleLabel = [WLTools allocLabel:@"" font:systemBoldFont(ScaleW(14)) textColor:kTitleColor frame:CGRectMake(0, 0, ScreenWidth, ScaleW(48)) textAlignment:NSTextAlignmentCenter];
        _titleLabel.backgroundColor = kSubBgColor;
...
-(void)setItemsArray:(NSArray *)itemsArray
{
    ...
    for (int i = 0; i < self.itemsArray.count; i++) {
        ...
        UIView *lineView = [[UIView alloc]initWithFrame:CGRectMake(0, btn.height - 0.5, btn.width, 0.5)];
