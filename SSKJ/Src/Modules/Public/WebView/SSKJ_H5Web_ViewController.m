...
//    self.title = SSKJLocalized(@"帮助中心", nil);
...
{
    if (nil == _webView) {
        _webView = [[WKWebView alloc]initWithFrame:CGRectMake(0, Height_NavBar + ScaleW(10), ScreenWidth, ScreenHeight - Height_NavBar-ScaleW(10))];
